                ...
                var pokemonOwners = new List<PokemonOwner>()
                {
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                ...
                                new Review { Title="Pikachu",Text = "Pickchu, pickachu, pickachu", Rating = 1,
                                Reviewer = new Reviewer(){ FirstName = "Jessica", LastName = "McKay" } },
                            }
                        },
                        Owner = new Owner()
                        {
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                new Review { Title="Venasuar",Text = "Venasuar is the best pokemon, because it is electric", Rating = 5,
                                Reviewer = new Reviewer(){ FirstName = "Teddy", LastName = "Smith" } },
                                new Review { Title="Venasuar",Text = "Venasuar is the best at killing rocks", Rating = 5,
                                Reviewer = new Reviewer(){ FirstName = "Taylor", LastName = "Jones" } },
